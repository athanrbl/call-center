package com.callcenter.call_center.service;

import com.callcenter.call_center.repository.UserRepository;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        com.callcenter.call_center.model.User user = userRepository.findByUsername(username);
